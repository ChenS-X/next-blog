...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${inter.className} bg-white dark:bg-stone-950 text-stone-900 dark:text-stone-100 min-h-screen flex flex-col transition-colors duration-300`}>
          ...
          <footer className="border-t border-stone-100 dark:border-stone-900 py-16">
            <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-8">
              ...
              <div className="flex gap-8 text-sm text-stone-400 dark:text-stone-600">
                ...
                <a href="#" className="hover:text-stone-900 dark:hover:text-stone-100 transition-colors">GitHub</a>
              </div>
            </div>
          </footer>
        </ThemeProvider>
